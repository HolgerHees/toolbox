...
$intervalConfigs = Environment::getMySQLIntervalConfigs();
$dbGroups = Environment::getMySQLPersistanceGroups();
...
$job->generateMySQLIntervalValues( $dbGroups, $intervalConfigs );
